...
<body id="sobre-mi">
    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/foto.jpg" alt="Jan Carlo Martinez" title="Jan Carlo Martinez"
        ...
        <div id="ie" class="row shadow bg-white rounded p-1">
            <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <a href="https://nuevacolombiaied.wixsite.com/colegio" target="_blank"><img
                                src="images/Nueva Colombia.jpg" class="img-fluid baw" title="Estudios"></a>
                    </div>
                    <div class="col-12- col-sm-10 p-3">
                        <h3>Estudios de primaria</h3>
                        <h4>Colegio Nueva Colombia I.E.D</h4>
                        <h5>2011 – 2016</h5>
                        <a href="https://nuevacolombiaied.wixsite.com/colegio"
                            target="_blank">https://nuevacolombiaied.wixsite.com/colegio</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <a href="https://ieelhato.controlacademico.com/" target="_blank"> <img
                                src="images/Institucion El Hato.png" class="img-fluid baw" title="Estudios"></a>
                    </div>
                    <div class="col-12- col-sm-10 p-3">
                        <h3>Estudios Secundaria basica</h3>
                        <h4>Institucion Educativa El Hato Pesca</h4>
                        <h5>2017 – 2019</h5>
                        <a href="https://ieelhato.controlacademico.com/"
                            target="_blank">https://ieelhato.controlacademico.com/</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <a href="https://ieciudadlahormiga.jimdofree.com/" target="_blank"> <img
                                src="images/Ciudad La Hormiga.jpg" class="img-fluid baw" title="Estudios"></a>
                    </div>
                    <div class="col-12- col-sm-10 p-3">
                        <h3>Estudios Secundaria Media</h3>
                        <h4>Institucion Educativa Ciudad La Hormiga</h4>
                        <h5>2020 – 2022</h5>
                        <a href="https://ieciudadlahormiga.jimdofree.com/"
                            target="_blank">https://ieciudadlahormiga.jimdofree.com/</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row py-5 mx-0">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="row ml-sm-2 bg-white card-idioma shadow ms-sm-1">
                            ...
                            <div class="col-8 p-5" style="padding: 27px 47px! important;">
                                <h2>HOBBIES</h2>
                                <ul>
                                    <li>Tenis</li>
                                    <li>Salto alto</li>
